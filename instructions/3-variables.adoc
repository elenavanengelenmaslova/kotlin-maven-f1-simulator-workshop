...
In your IDE, locate the Scratch file (often called `scratch.kts`), which should be in the *Scratches and Consoles* > *Scratches*.

Instantiate the RaceCar and Driver classes with appropriate arguments and print some of their properties. Here's an example:
...
Try updating some mutable properties and see how they affect the state of the objects:
...
Try to access internal and private variables of a `RaceCar`. What happens?
