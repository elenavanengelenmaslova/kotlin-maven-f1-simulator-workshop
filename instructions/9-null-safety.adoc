...
- Update unit test to ensure null sponsor is resilient to chane in default value of sponsor in the constructor: https://github.com/elenavanengelenmaslova/kotlin-maven-f1-simulator-workshop/commit/d23008c4089dc01c8a217d3dd8b006352fc97062
